                  ...
                  child: GridView.builder(
                   ...
                   // scrollDirection: Axis.horizontal,
                    ...
                    itemBuilder: (context, index) {
                      return TutorWidget(Tutor: searchedTutors.elementAt(index));
                    },
                  ),
                ),
              ),
                          ...
                          children: [
                            ...
                            IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  if(titleController.text.isNotEmpty && dateController.text.isNotEmpty && problemController.text.isNotEmpty && timeController.text.isNotEmpty){
                                  DatabaseAPI.createNewSession(titleController.text, problemController.text, dateController.text, tutor , timeController.text);
                                  }
                                }),
                          ],
                        ),
                                ...
                                decoration: InputDecoration(
                                  suffixIcon: GestureDetector(
                                    ...
                                    onTap: (){
                                      showDatePicker(
                                          context: context,
                                          initialDate: _preffredDate == null ? DateTime.now() : _preffredDate,
                                          firstDate: DateTime.now(),
                                          lastDate: DateTime(2022)
                                      ).then((value) => dateController.text = value.year.toString()+"-"+value.month.toString()+"-"+value.day.toString());
                                    },
                                  ),
                                  hintText: 'Type something...',
                                  hintStyle:
